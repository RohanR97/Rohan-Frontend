...
function LocalAddress() {
  ...
  return (
    <div className="container mt-5">
      <h2 className="text-center mb-4 text-primary">Local Address</h2>
      ...
      <form onSubmit={handleSubmit(saveData)} className="row g-3">
        ...
        <div className="col-md-6">
          ...
          <input type="number" className="form-control" {...register("houseNumber", { required: true })} />
        ...
        <div className="col-12 text-center mt-4">
          ...
          <button type="button" className="btn btn-secondary px-5" onClick={() => navigate("/dashboard/address")}>Back</button>
        </div>
      </form>
    </div>
  );
